...
public class PhonesPDAsPageObject extends Base {
	...
	PageFactory.initElements(driver, this); 
			...
			@FindBy(xpath = "//body/div[2]/ul/li[2]/a[contains(text(), 'Phones & PDAs')]")
			...
			@FindBy(xpath = "//div/a[6][@class='list-group-item active']")
			...
			private WebElement HTCTouchTitle;
			
			@FindBy(xpath = "//p[contains(text(), 'HTC Touch - in High Definition.')]")
			private WebElement HTCTouchDescription;
			
			@FindBy(xpath = "/html/body/div[2]/div/div/div[2]/div[1]/div/div[2]/div[1]/p[2][contains(text(), '$122.00')]")
			private WebElement HTCTouchPrice;
			
			@FindBy(xpath = "//span[contains(text(), 'Ex Tax: $100.00')]")
			private WebElement HTCTouchTax;
...
//			private WebElement HTCTouchCompare;
...
//			private WebElement IphoneCompare;
			...
			private WebElement PalmTreoImage;
			
			@FindBy(linkText = "Palm Treo Pro")
			private WebElement PalmTreoTitle;
			
			@FindBy(xpath = "//p[contains(text(), 'Redefine your workday with the Palm')]")
			private WebElement PalmTreoDescription;
			
			@FindBy(xpath = "//p[contains(text(), '$337.99')]")
			private WebElement PalmTreoPrice;
			
			@FindBy(xpath = "//span[contains(text(), 'Ex Tax: $279.99')]")
			private WebElement PalmTreoTax;
			
//			@FindBy(xpath = "//button[@onclick="cart.add('29', '1');"]")
//			private WebElement PalmTreoAddToCart;
//			
//			@FindBy(xpath = "//button[@onclick="wishlist.add('29');"]")
//			private WebElement PalmTreoAddToWishList;
//					
