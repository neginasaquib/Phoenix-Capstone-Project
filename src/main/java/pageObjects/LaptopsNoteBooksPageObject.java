...
public class LaptopsNoteBooksPageObject extends Base {
	...
	@FindBy(xpath = "//body/div[2]/ul/li[2]/a[contains(text(), 'Laptops & Notebooks')]")
	private WebElement LaptopsNoteBooksSublink;
	...
	private WebElement LaptopsAndNotebooksPageObjectText;

	@FindBy(xpath = "//img[@title='Laptops & Notebooks']")
	private WebElement LaptopsAndNotebooksThumbnail;

	@FindBy(xpath = "//p[contains(text(), 'Shop Laptop feature only the best laptop')]")
	private WebElement LaptopsAndNotebooksDescription;

	@FindBy(xpath = "//h3[contains(text(), 'Refine Search')]")
	private WebElement RefineSearch;

	@FindBy(xpath = "//div[@class='col-sm-3']/ul/li/a[contains(text(), 'Macs (0)')]")
	private WebElement MacLink;

	@FindBy(xpath = "//div[@class='col-sm-3']/ul/li[2]/a[contains(text(), 'Windows (0)')]")
	...
	private WebElement HPLP3065Title;

	@FindBy(xpath = "//div/p[contains(text(), 'Stop your co-workers in their tracks with the stunning new 30-inch')]")
	private WebElement HPLP3065Description;

	@FindBy(xpath = "//p[contains(text(), '$122.00')]")
	private WebElement HPLP3065Price;

	@FindBy(xpath = "//p[@class='price']/span[contains(text(), 'Ex Tax: $100.00')]")
	private WebElement HPLP3065Tax;

//	@FindBy(xpath = "//button[@onclick="cart.add('47', '1');"]")
//				private WebElement HPLP3065AddToCart;
//
//	@FindBy(xpath = "//button[@onclick="wishlist.add('47');"]")
//				private WebElement HPLP3065AddToWishList;
//
//	@FindBy(xpath = "//button[@onclick="compare.add('47');"]")
//				private WebElement HPLP3065Compare;
	...
	@FindBy(xpath = "//div[2]/div/div/div[4]/div[2]/div/div[2]/div[1]/p[1][contains(text(), 'Intel Core 2 Duo processor')]")
	private WebElement MacBookDescription;

	@FindBy(xpath = "//div[2]/div/div/div[4]/div[2]/div/div[2]/div[1]/p[2][contains(text(), '$602.00')]")
	private WebElement MacBookPrice;

	@FindBy(xpath = "//div[2]/div/div/div[4]/div[2]/div/div[2]/div[1]/p[2]/span[contains(text(), 'Ex Tax: $500.00')]")
...
//
	...
	@FindBy(xpath = "//div[2]/div/div/div[4]/div[4]/div/div[2]/div[1]/p[1]")
	private WebElement MacBookProDescription;

//	@FindBy(xpath = "//div[2]/div/div/div[4]/div[4]/div/div[2]/div[1]/p[2][contains(text(), '$2,000.00')]")
//	private WebElement MacBookProPrice;

	@FindBy(xpath = "//div[2]/div/div/div[4]/div[4]/div/div[2]/div[1]/p[2]/span[contains(text(), 'Ex Tax: $2,000.00')]")
	private WebElement MacBookProTax;

//	@FindBy(xpath = "//button[@onclick="cart.add('45', '1');"]")
//				private WebElement MacBookProAddToCart;
//
//	@FindBy(xpath = "//button[@onclick="wishlist.add('45');"]")
...
//
	...
	private WebElement SonyVAIOTitle;

	@FindBy(xpath = "/html/body/div[2]/div/div/div[4]/div[5]/div/div[2]/div[1]/p[1][contains(text(), 'Unprecedented power. ')]")
	private WebElement SonyVAIODescription;

	@FindBy(xpath = "//div[2]/div/div/div[4]/div[5]/div/div[2]/div[1]/p[2][contains(text(), '$1,202.00')]")
	private WebElement SonyVAIOPrice;

	@FindBy(xpath = "//div[2]/div/div/div[4]/div[5]/div/div[2]/div[1]/p[2]/span[contains(text(), 'Ex Tax: $1,000.00')]")
	private WebElement SonyVAIOTax;
...
//				private WebElement SonyVAIOCompare;
...
//------------------------------------------------------------------
//	For Scenario: Add and Remove a Mac book from Cart
	
	
	@FindBy(xpath = "//a[@class='dropdown-toggle'][contains(text(),'Laptops & Notebooks')]")
	private WebElement LaptopsAndNotebooksMenu;

	@FindBy(xpath = "//a[contains(text(),'Show All Laptops & Notebooks')]")
	private WebElement ShowAllLaptopsAndNotebooks;
	
	@FindBy(xpath = "//a[@href='http://tek-school.com/retail/index.php?route=product/product&path=18&product_id=43'][contains(text(),'MacBook')]")
	...
	private WebElement MacSuccess;
	
	@FindBy(xpath = "//span[@id='cart-total']")
	private WebElement cartTotal;
	
	@FindBy(xpath = "//div[@id='cart']")
	private WebElement MacCart;
	
	@FindBy(xpath = "//td[@class='text-center']//button[@type='button']")
	private WebElement xButton;
	
	@FindBy(xpath = "//span[@id='cart-total']")
	private WebElement macRemoveMessage;
	
	
	public void clickLaptopsTab() {
		LaptopsAndNotebooksMenu.click();
		
//		Utilities.waitAndClickElement(LaptopsAndNotebooksMenu);
	}
	
	public void clickLaptopsAlltab() {
...
//		Utilities.waitAndClickElement(MacBookImage);
		MacBookName.click();
	}
...
//		Utilities.waitAndClickElement(MacBookAddToCart);
	}
	
//	negina: public void macSuccessMessage() {
//		String actualSuccessMessage = MacSuccess.getText();
//		String expectedSuccessMessage = "Success: You have added MacBook to your shopping cart!\n×";
//		Assert.assertEquals(actualSuccessMessage, expectedSuccessMessage);
//	}
//	
//	public String macSuccessMessageAssert() {
//		String macSuccessMessage = MacSuccess.getText();
//		return macSuccessMessage; 
//	}

	public void macSuccessMessage(String strSuccessMessage) {
		String actualSuccessMessage = MacSuccess.getText();
...
//	negina: public void verifyCartTotal() {
...
//	public verifyCartTotalAssert() {
//		String verifyTotal = cartTotal.getText();
//		return verifyTotal;
//	}
//	
	public void verifyCartTotalAssert(String verifyCart) {
		String actualCartTotal = cartTotal.getText();
		Assert.assertEquals(verifyCart, actualCartTotal);
	}
	
	public void macCart() {
		MacCart.click();
		
//		Utilities.waitAndClickElement(MacCart);
//		try {
//			Thread.sleep(3000);
//		} catch (Exception e) {
//			e.printStackTrace();
...
//		Utilities.waitAndClickElement(xButton);
//		try {
//			Thread.sleep(3000);
//		} catch (Exception e) {
//			e.printStackTrace();
...
//	public void macRemoval(String macRemove) {
//		String actualMessage = macRemoveMessage.getText();
//		System.out.println("actual cart total after removing: =======" + actualMessage);
//		Assert.assertEquals(macRemove, actualMessage);
//		System.out.println(actualMessage);
//	}
	
//	public String macRemovalAssert1() {
//		String macRemove = macRemoveMessage.getText();
//		return macRemove;
//	}

		
		public void macRemovalAssert(String strCartTotalAfterRemove) {
			String actualCartTotal = cartTotal.getText();
...
//-------------------------------------------------------------------------
//		For Scenario: Product Comparison 		
	
		
		@FindBy(xpath = "//body/div[@id='product-category']/div[@class='row']/div[@id='content']/div[@class='row']/div[2]/div[1]/div[2]/div[2]/button[3]")
		private WebElement MacBookCompare;
		
		@FindBy(xpath = "/html/body/div[@id='product-category']/div[@class='row']/div[@id='content']/div[@class='row']/div[3]/div[1]/div[2]/div[2]/button[3]")
		private WebElement MacBookAirCompare;
	
		@FindBy(xpath = "/html/body/div[2]/div[1]")
		private WebElement comparisonSuccess;
		
		@FindBy(xpath = "//a[contains(text(),'product comparison')]")
		private WebElement comparisonLinkclick;
		
		@FindBy(xpath = "//table[@class='table table-bordered']")
		private WebElement comparisonTable;
		
		
		public void macBookCompareButton() {
			MacBookCompare.click();
		}
		
		public void macBookAirCompareButton() {
			MacBookAirCompare.click();
					
		}
		
		public void compareMacBookAirAddSuccessAssert(String macBookAirAdd) {
			String actualMacSuccessMessage = comparisonSuccess.getText();
			String strMacString = actualMacSuccessMessage.substring(0, 63);
			Assert.assertEquals(macBookAirAdd, strMacString);
		}
		
//		public void compareMacBookAirAddSuccessAssert(String macBookAirAdd) {
//			String actualSuccessMessage = MacBookAirCompare.getText();
//			System.out.println("Success Message: " + actualSuccessMessage);
//			Assert.assertEquals(macBookAirAdd, actualSuccessMessage);
//			System.out.println(actualSuccessMessage);
//		}
		
		
		public void comparisonLink() {
			comparisonLinkclick.click();
		}
...
//-------------------------------------------------------------------------
//		For Scenario: Adding an item to Wish list 
		...
		public void heartSony() {
			SonyVAIOAddToWishList.click();
		}
		
		public void loginForWishlistAssert(String loginText) {
			String actualLoginMessage =  LoginFirst.getText();
			String strLoginMessage = actualLoginMessage.substring(0, 72);
			Assert.assertEquals(loginText, strLoginMessage);
		}
		
//-------------------------------------------------------------------------
//		For Scenario: Validate the price of MacBook Pro is $2,000.00 
		...
		public void clickMacBookPro() {
			MacBookProTitle.click();
		}
		
		public void macPrice(String priceDisplay) {
			String actualPrice = MacBookProPrice.getText();
			Assert.assertEquals(actualPrice, priceDisplay);
