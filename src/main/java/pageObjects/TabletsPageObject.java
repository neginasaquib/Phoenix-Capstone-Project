...
public class TabletsPageObject extends Base {
	...
	PageFactory.initElements(driver, this); 
			...
			private WebElement SamsungTabImage;
			
			@FindBy(linkText = "Samsung Galaxy Tab 10.1")
			private WebElement SamsungTabTitle;
			
			@FindBy(xpath = "//p[contains(text(), 'Samsung Galaxy Tab 10.1, is the world’s thinnest tablet')]")
			private WebElement SamsungTabDescription;
			
			@FindBy(xpath = "//p[contains(text(), '$241.99')]")
			private WebElement SamsungTabPrice;
			
			@FindBy(xpath = "//span[contains(text(), 'Ex Tax: $199.99')]")
			private WebElement SamsungTabTax;
			
//			@FindBy(xpath = "//button[@onclick="cart.add('49', '1');"]")
//			private WebElement SamsungTabAddToCart;
//			
//			@FindBy(xpath = "//button[@onclick="wishlist.add('49');"]")
//			private WebElement SamsungTabAddToWishList;
//					
//			@FindBy(xpath = "//button[@onclick="compare.add('49');"]")
//			private WebElement SamsungTabCompare;
